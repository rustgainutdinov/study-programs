...
<script>
  export default {
    ...
    data() {
      return {
        imagePath: 'https://lubava12.ru/get_image?image_path=universities/default/index.jpg&compress_percent=80&compress_width=600&compress_height=600'
      }
    },
    methods: {
      checkImg(titleInEnglish) {
        ...
        this.$axios.$head('/get_image', {
          ...
          .then(result => {
            this.imagePath = 'https://lubava12.ru/get_image?image_path=' + path + '&compress_percent=80&compress_width=500&compress_height=500';
          })
          .catch(result => {
            console.log('error');
          })
