...
<script>
  export default {
    ...
    data() {
      return {
        imagePath: 'https://jbl--shop.ru/get_image?image_path=universities/default/index.jpg&compress_percent=90&compress_width=1000&compress_height=300'
      }
    },
    methods: {
      checkImg(titleInEnglish) {
        ...
        this.$axios.$head('/get_image', {
          ...
          .then(result => {
            this.imagePath = 'https://jbl--shop.ru/get_image?image_path=' + path + '&compress_percent=90&compress_width=1000&compress_height=400';
          })
          .catch(result => {
            console.log('error');
          })
